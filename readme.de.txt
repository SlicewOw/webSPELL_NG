...
2. Installation
	...
	1. Anforderungen
	    ...
	    * Webspace mit PHP- und MySQL-Unterstützung (PHP >= 5.3, MySQL >= 4.1)
	    * (g)unzip/tar zum Entpacken des webSPELL Paketes
...
3. Weiterführende Links
	...
	http://github.com/webSPELL/webSPELL-4.2.3
    	Offizielle webSPELL Github Repo (code, issues, wiki)
