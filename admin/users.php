...
<div class="form-group">
 ...
 <div class="form-group">
    <div class="col-sm-offset-2 col-sm-10">
        ...
        <button class="btn btn-success btn-xs" type="submit" name="ban"  />' . $_language->module[ 'edit_ban' ] . '</button>
    </div>
  </div>
...
<button class="btn btn-success btn-xs" type="submit" name="add">'.$_language->module['add_to_clan'].'</button>
     </div>
    </div>
  </form>
  </div></div>';
...
<div class="form-group">
    <div class="col-sm-offset-2 col-sm-10">
        ...
        <button class="btn btn-success btn-xs" type="submit" name="newuser"  />' . $_language->module[ 'add_new_user' ] . '</button>
    </div>
  </div>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-8">
    <input name="userpic" type="file" size="40" /> <small>'.$_language->module['max_230x210'].'</small><br><input type="checkbox" name="userpic" value="1" /> '.$_language->module['delete_picture'].'
    </div>
  </div>
  <form class="form-horizontal">
  <div class="form-group">
  ...
  <div class="form-group">
    <label class="col-sm-2 control-label">'.$_language->module['clantag'].'</label>
    <div class="col-sm-8">
    <input class="form-control" type="text" name="clantag" value="'.getinput($ds['clantag']).'" size="60" />
    </div>
  </div>
  <div class="form-group">
    <label class="col-sm-2 control-label">'.$_language->module['clanname'].'</label>
    <div class="col-sm-8">
    <input class="form-control" type="text" name="clanname" value="'.getinput($ds['clanname']).'" size="60" />
    </div>
  </div>
  <div class="form-group">
    <label class="col-sm-2 control-label">'.$_language->module['clan_homepage'].'</label>
    <div class="col-sm-8">
    <input class="form-control" type="text" name="clanhp" value="'.getinput($ds['clanhp']).'" size="60" />
    </div>
  </div>
  <div class="form-group">
    <label class="col-sm-2 control-label">'.$_language->module['clan_irc'].'</label>
    <div class="col-sm-8">
    <input class="form-control" type="text" name="clanirc" value="'.getinput($ds['clanirc']).'" size="60" />
    </div>
  </div>
  <div class="form-group">
    <label class="col-sm-2 control-label">'.$_language->module['clan_history'].'</label>
    <div class="col-sm-8">
    <input class="form-control" type="text" name="clanhistory" value="'.getinput($ds['clanhistory']).'" size="60" />
    </div>
  </div>
  <div class="form-group">
    <label class="col-sm-2 control-label">'.$_language->module['cpu'].'</label>
    <div class="col-sm-8">
    <input class="form-control" type="text" name="cpu" value="'.getinput($ds['cpu']).'" size="60" />
    </div>
  </div>
  <div class="form-group">
    <label class="col-sm-2 control-label">'.$_language->module['mainboard'].'</label>
    <div class="col-sm-8">
    <input class="form-control" type="text" name="mainboard" value="'.getinput($ds['mainboard']).'" size="60" />
    </div>
  </div>
  <div class="form-group">
    <label class="col-sm-2 control-label">'.$_language->module['ram'].'</label>
    <div class="col-sm-8">
    <input class="form-control" type="text" name="ram" value="'.getinput($ds['ram']).'" size="60" />
    </div>
  </div>
  <div class="form-group">
    <label class="col-sm-2 control-label">'.$_language->module['monitor'].'</label>
    <div class="col-sm-8">
    <input class="form-control" type="text" name="monitor" value="'.getinput($ds['monitor']).'" size="60" />
    </div>
  </div>
  <div class="form-group">
    <label class="col-sm-2 control-label">'.$_language->module['graphiccard'].'</label>
    <div class="col-sm-8">
    <input class="form-control" type="text" name="graphiccard" value="'.getinput($ds['graphiccard']).'" size="60" />
    </div>
  </div>
  <div class="form-group">
    <label class="col-sm-2 control-label">'.$_language->module['soundcard'].'</label>
    <div class="col-sm-8">
    <input class="form-control" type="text" name="soundcard" value="'.getinput($ds['soundcard']).'" size="60" />
    </div>
  </div>
  <div class="form-group">
    <label class="col-sm-2 control-label">'.$_language->module['connection'].'</label>
    <div class="col-sm-8">
    <input class="form-control" type="text" name="connection" value="'.getinput($ds['verbindung']).'" size="60" />
    </div>
  </div>
  <div class="form-group">
    <label class="col-sm-2 control-label">'.$_language->module['keyboard'].'</label>
    <div class="col-sm-8">
    <input class="form-control" type="text" name="keyboard" value="'.getinput($ds['keyboard']).'" size="60" />
    </div>
  </div>
  <div class="form-group">
    <label class="col-sm-2 control-label">'.$_language->module['mouse'].'</label>
    <div class="col-sm-8">
    <input class="form-control" type="text" name="mouse" value="'.getinput($ds['mouse']).'" size="60" />
    </div>
  </div>
  <div class="form-group">
    <label class="col-sm-2 control-label">'.$_language->module['mousepad'].'</label>
    <div class="col-sm-8">
    <input class="form-control" type="text" name="mousepad" value="'.getinput($ds['mousepad']).'" size="60" />
    </div>
  </div>
  <div class="form-group">
