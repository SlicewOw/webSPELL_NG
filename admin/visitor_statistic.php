...
<input type="text" id="year2" style="width:40px;" />.<input type="text" id="month" style="width:30px;" /> <input class="btn btn-primary btn-xs" type="button" onclick="display_stat(document.getElementById('year2').value, document.getElementById('month').value);" value="<?php echo $_language->module['show']; ?>" /> <?php echo $_language->module['yyyy_mm']; ?>
