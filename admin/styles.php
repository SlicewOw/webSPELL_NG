...
echo '<div class="card">
  <div class="card-header">
    ...
    <li class="nav-item"><a class="nav-link active" href="admincenter.php?site=styles">Style</a></li>
...
if (isset($_POST[ 'submit' ])) {
    ...
    echo '<form class="form-horizontal" method="post" action="admincenter.php?site=styles" enctype="multipart/form-data">
...
<div class="form-group">
    <label class="col-sm-2 control-label">' . $_language->module[ 'page_title' ] . ':</label>
    <div class="col-sm-8"><span class="text-muted small"><em>
    <input class="form-control" type="text" name="title" value="' . getinput($ds[ 'title' ]) . '" /></em></span>
    </div>
  </div>
