...
<div class="panel-body">';
  ...
  <table class="table table-striped">
    ...
    while ($db = mysqli_fetch_array($moduls)) {
	  ...
	  <a href="admincenter.php?site=moduls&amp;action=edit&amp;modulID='.$db['modulID'].'"  class="mobile visible-xs visible-sm" type="button"><span class="fa fa-pencil"></span></a>
      <a class="mobile visible-xs visible-sm" type="button" onclick="MM_confirm(\'' . $_language->module['really_delete'] . '\', \'admincenter.php?site=moduls&amp;delete=true&amp;modulID='.$db['modulID'].'&amp;captcha_hash='.$hash.'\')" /><span class="fa fa-times"></span></a>
