...
onsubmit="return chkFormular();">
  ...
  <div class="form-group">
    ...
    <div class="col-md-9">
		<span class="pull-right text-muted small"><em><input class="form-control" type="text" name="name" /></em></span>
    </div>
  </div>
  </div>
  <div class="row bt">
 ...
 <div class="row bt">
  <div class="form-group">
    ...
    <div class="col-md-9">
		<span class="pull-right text-muted small"><em>'.$games.'</em></span>
    </div>
  </div>
  </div>
...
<div class="row bt"><div class="col-md-12">'.$_language->module['squad_info'].':</div>
  <div class="form-group">
    ...
    <div class="col-sm-12">
		'.$addflags.'
		'.$addbbcode.'<br>
		<textarea class="form-control id="message" rows="5" cols="" name="message" style="width: 100%;"></textarea>
    </div>
  </div>

  <div class="form-group">
    <div class="col-sm-12"><br>
      <input type="hidden" name="captcha_hash" value="'.$hash.'" /><button class="btn btn-success btn-xs" type="submit" name="save" />'.$_language->module['add_squad'].'</button>
    </div>
  </div>
  </div>
    </form></div>
...
<div class="row bt">
  ...
  <div class="form-group">
    <label class="col-md-3 control-label">'.$_language->module['squad_name'].':</label>
    <div class="col-md-9">
		<span class="pull-right text-muted small"><em><input class="form-control" type="text" name="name" value="'.getinput($ds['name']).'" /></em></span>
    </div>
  </div>
  </div>
  <div class="row bt">
...
<div class="row bt"><div class="col-md-12">'.$_language->module['squad_info'].':</div>
  ...
  <div class="form-group">
    <div class="col-sm-12"><br>
      <input type="hidden" name="captcha_hash" value="'.$hash.'" /><input type="hidden" name="squadID" value="'.getforminput($squadID).'" /><button class="btn btn-success btn-xs" type="submit" name="saveedit" />'.$_language->module['edit_squad'].'</button>
    </div>
  </div>
  </div>
  </form></div>
...
<thead>
    ...
    if ($anzsquads) {
	  ...
	  <a href="admincenter.php?site=squads&amp;action=edit&amp;squadID='.$db['squadID'].'"  class="mobile visible-xs visible-sm" type="button"><span class="bi bi-pencil-square"></span></a>
      <a class="mobile visible-xs visible-sm" type="button" onclick="MM_confirm(\'' . $_language->module['really_delete'] . '\', \'admincenter.php?site=squads&amp;delete=true&amp;squadID='.$db['squadID'].'&amp;captcha_hash='.$hash.'\')" /><span class="bi bi-trash-fill"></span></a></a></td>
        <td><select name="sort[]">';
