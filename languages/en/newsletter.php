...
/* do not edit above this line */
    ...
    'request_mail' => '<strong>You required your deletion key!</strong><br><br>To remove your mail adress from the maillist click <a href="http://%homepage_url%/index.php?site=newsletter&mail=%mail%&pass=%delete_key%">here</a><br>Your password to delete yourself: %delete_key%<br><br>See you at %homepage_url%',
    'send' => 'send',
    'submit' => 'submit',
    'success_mail' => '<strong>Thank you for your registration!</strong><br><br>To remove your mail adress from the maillist click <a href="http://%homepage_url%/index.php?site=newsletter&mail=%mail%&pass=%delete_key%">here</a><br>Your password to delete yourself: %delete_key%<br><br>See you at %homepage_url%',
