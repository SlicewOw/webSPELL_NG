...
/* do not edit above this line */
    ...
    'request_mail' => '<strong>Vous avez demandé une clé de suppression manuelle !</strong><br><br>Pour vous retirer, cliquez <a href="http://%homepage_url%/index.php?site=newsletter&mail=%mail%&pass=%delete_key%">ici</a><br>Le mot de passe pour vous retirer manuellement: %delete_key%<br><br>Le staff, %homepage_url%',
    'send' => 'Envoyer',
    'submit' => 'Envoyer',
    'success_mail' => '<strong>Merci de vous être inscrit &aacute; notre newsletter!</strong><br><br>Pour vous retirer, cliquez <a href="http://%homepage_url%/index.php?site=newsletter&mail=%mail%&pass=%delete_key%">ici</a><br>Le mot de passe pour vous retirer manuellement: %delete_key%<br><br>Le staff, %homepage_url%',
