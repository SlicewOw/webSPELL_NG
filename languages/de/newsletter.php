...
/* do not edit above this line */
    ...
    'request_mail' => '<strong>Du hast deinen Entfernungscode angefordert.</strong><br><br>Um deine Mailadresse von der Mailing-Liste zu entfernen, klicke folgenden Link an: <a href="http://%homepage_url%/index.php?site=newsletter&mail=%mail%&pass=%delete_key%">Mailadresse entfernen</a><br>Das Passwort zum Entfernen von der Liste lautet: %delete_key%<br><br>Bis demnächst auf %homepage_url%',
    'send' => 'senden',
    'submit' => 'abschicken',
    'success_mail' => '<strong>Vielen Dank für deine Anmeldung!</strong><br><br>Wenn du deine Mailadresse von der Mailing-Liste entfernen willst, nutze bitte folgenden Link: <a href="http://%homepage_url%/index.php?site=newsletter&mail=%mail%&pass=%delete_key%">Mailadresse entfernen</a><br>Das Passwort zum Entfernen von der Liste lautet: %delete_key%<br><br>Bis demnächst auf %homepage_url%',
